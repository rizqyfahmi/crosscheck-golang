...
var _ = Describe("RegistrationUsecase", func() {
	...
	Describe("Registration parameters", func() {
		When("AuthRepository returns UserEntity", func() {
			It("makes RegistrationUsecase returns AuthEntity", func() {
				...
				usecase := authregistrationuc.New(mockAuthRepository, mockAccessToken, mockRefreshToken, mockHash)
		...
		When("password fails to hash", func() {
		...
		When("AuthRepository insert data returns error", func() {
		...
		When("AuthRepository is mapping the inserted data into UserEntity returns error", func() {
